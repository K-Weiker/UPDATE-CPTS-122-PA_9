...
public:
	...
	std::vector<std::tuple <int, int, Piece::MoveType>> getPossibleMoves() { return mPosMoves; };
	...
	virtual void calPosMoves(Piece* field[8][8], bool checkCheck) = 0;
...
protected:
	...
	std::vector<std::tuple <int, int, Piece::MoveType>> mPosMoves;
