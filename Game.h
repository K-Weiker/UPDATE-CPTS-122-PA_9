...
public:
    ...
    void showPossMoves(Piece* piece);

    // undos the showPossMoves function
    void undoshowPossMoves(Piece* piece);

    // get chess board field for test
    Piece* (*getField())[8] { return m_field; } 

    // get SDL tools for test 
    SDL_Handler* getHandler() { return mHandler; }
